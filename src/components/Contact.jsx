import { Circle, Mail, MapPinIcon, Phone, Rows, Send } from "lucide-react";
...
const Contact = () => {
  const contactInfo = [
    ...
    },
    {
      ...
      title: "Address",
      content: "Chiniot Punjab Pakistan",
      aosDelay: "200",
    },
  ];
  const formFeilds = [
  ...
  return (
    <section
      id="contact"
      className="relative overflow-hidden bg-gradient-to-brfrom-blue-50to-purple-50 py-12 px-4 sm:py-16 md:py-20 md:px-12 lg:px-20"
    >
...
items-center"
        >
          <div
            className="flex-1 bg-white rounded-2xl md: rounded-3xl shadow-lg md: shadow-xl p-6 sm:p-8 border border-gray-100"
            data-aos="fade-right"
            data-aos-delay="100"
          >
      ...
      ></div>
      <div
        className="hidden md:block absolute border-2 border-purple-500 top-40 right-10 w-20 h-20 sm:w-24 sm:h-24 md:w-32 md:h-32 rounded-full opacity-50"
        data-aos="zoom-in"
        data-aos-delay="500"
      ></div>
    </section>
